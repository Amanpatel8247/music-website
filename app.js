...
const songs = [
  ...
  {
    id: "16",
    songName: `Tu Meri Jindagi Mai Tu<br>
        <div class="subtitle>Jubin Nautiyal</div>`,
    poster: "img/16.jpg",
  },
  {
  ...
  },
  {
    ...
    songName: `Eh Munde Pagal Ne Saare<br>
        <div class="subtitle>Ap Dillon, Gurinder Gill, Shinda Kahlon</div>`,
    poster: "img/19.jpg",
  },
  {
    id: "20",
...
const makeAllplays = () => {
  Array.from(document.getElementByClassName("playListPlay")).forEach((el) => {
    el.classList.add("bi-play-circle-fill");
    el.classList.remove("bi-pause-circle-fill");
  });
};
const makeAllBackground = () => {
  Array.from(document.getElementByClassName("songItem")).forEach((el) => {
...
Array.from(document.getElementsByClassName("playListPlay")).forEach((e) => {
  e.addEventListener("click", () => {
    ...
    makeAllBackground();
    Array.from(document.getElementByClassName("songItem"))[
      index - 1
...
let Artist_bx = document.getElementByClassName("Artist_bx")[0];
